...
export default function VasteLastenPage() {
  ...
  const [items, setItems] = useState<VasteLast[]>([]);
  ...
  return (
    <>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Vaste Lasten</h1>
        <p className="text-gray-600 dark:text-white/60 mt-1 text-sm">Voeg je vaste maandelijkse kosten toe.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div className="bg-white dark:bg-[#111111] rounded-2xl border border-gray-100 dark:border-white/10 p-6 transition-colors duration-200">
          <h3 className="font-semibold text-gray-800 dark:text-white/80 text-sm mb-4">Vaste last toevoegen</h3>
        ...
        <div className="bg-white dark:bg-[#111111] rounded-2xl border border-gray-100 dark:border-white/10 p-6 transition-colors duration-200">
          <h3 className="font-semibold text-gray-800 dark:text-white/80 text-sm mb-4">Vaste lasten</h3>
          {items.length === 0 ? (
            <p className="text-sm text-gray-500 dark:text-white/50 text-center py-8">Nog geen vaste lasten toegevoegd.</p>
          ) : (
