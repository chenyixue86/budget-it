...
export default function UitgavesPage() {
  ...
  return (
    <>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Uitgaves</h1>
        <p className="text-gray-400 mt-1 text-sm">Voeg je maandelijkse uitgaves toe.</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-5">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6">
          <h3 className="font-semibold text-gray-800 text-sm mb-4">Uitgave toevoegen</h3>
        ...
        {/* List */}
        <div className="bg-white rounded-2xl border border-gray-100 p-6">
          <h3 className="font-semibold text-gray-800 text-sm mb-4">Uitgaven</h3>
          {items.length === 0 ? (
