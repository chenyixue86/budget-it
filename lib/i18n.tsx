...
const translations = {
  nl: {
    ...
    samenvatting: {
      ...
      subtitle: "Vergelijk je inkomsten en uitgaves over de afgelopen maanden.",
      laden: "Laden...",
      inkomsten: "Inkomsten",
      vasteLasten: "Vast",
      variabel: "Variabel",
      geenData: "Geen data",
      gemInkomsten: "Gem. inkomsten",
      gemUitgegeven: "Gem. uitgegeven",
      gemiddeld: "Gem. over",
      perMaand: "per maand",
      bestedPct: "Besteed van inkomen",
      detailTitle: "Per maand",
    },
    // Common
    common: {
      verwijder: "Verwijder",
  ...
  en: {
    ...
    samenvatting: {
      ...
      subtitle: "Compare your income and expenses over the past months.",
      laden: "Loading...",
      inkomsten: "Income",
      vasteLasten: "Fixed",
      variabel: "Variable",
      geenData: "No data",
      gemInkomsten: "Avg. income",
      gemUitgegeven: "Avg. spent",
      gemiddeld: "Avg. left",
      perMaand: "per month",
      bestedPct: "Spending vs income",
      detailTitle: "Per month",
    },
    common: {
      verwijder: "Delete",
      bewerken: "Edit",
